<%-- 
    ...
    Created on : 25 Jun, 2022, 1:53:05 PM
    Author     : rohit
--%>
            ...
            <div class="row"style="margin-top:2%" >
                ...
                <%
                    ...
                    try {
                        ...
                        Connection cn = DriverManager.getConnection("jdbc:mysql://localhost:3306/stackoverflow", "root", "");
                        Statement st = cn.createStatement();
                        ResultSet rs = st.executeQuery("Select * from question where email='" + user_email + "'");
                        while (rs.next()) {
                ...
                <div class='col-sm-12' id="question-<%=sn%>">
                    <div class="row">
                        ...
                        <div class="col-sm-1">
                            <i class="fa fa-trash" rel1="<%=sn%>"rel="<%=question_id%>" style="color:red;cursor:pointer"></i>
                        </div>
                    </div>
                </div>
